...
const NavBar = () => {
    return (
        <div className="navbar bg-base-100 h-[108px] p-0">
            <div className="w-full ">

                <div className="navbar-start bg-[#2e2d2d] h-[108px] w-[80%]">
                    ...
                    <Link className="btn btn-ghost normal-case text-xl text-white text-[50px] " to="/">SAIT</Link>
                </div>

            </div>
            <div className="navbar-center hidden lg:flex ">
                <ul className="menu menu-horizontal p-0 font-semibold text-xl flex items-center">
                    <li className="hover:bg-[#2e2d2d] hover:text-white">
                        <Link to="/about" className="active:bg-[#545353]" >About</Link></li>
